...
\begin{frame}{Important concepts for GPT and other Transformers models}
	\begin{itemize}
		\item Context Window
...
\begin{frame}{Parameters}
	\begin{itemize}
		...
		\item (...very roughly)
		\pause 
		\item But definitely correlates to resources needed to run the model.
		\pause
...
\begin{frame}
	\textit{Tokens} are *roughly* words, or portions of words.
\end{frame}
